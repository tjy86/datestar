...
user1 = User.create(:name => 'Churchlady', :password_digest => '1', :tagline => 'well isnt that special?', :age => '64', :gender => 'female', :city => 'church', :state => 'KS', :ethnicity => 'white', :description => 'religified old hag')
...
user2 = User.create(:name => 'BrianFellow', :password_digest => '1', :tagline => 'thats crazy!', :age => '35', :gender => 'male', :city => 'New York', :state => 'NY', :ethnicity => 'black', :description => 'yo mama' )
...
user3 = User.create(:name => 'MattFoley', :password_digest => '1', :tagline => 'in a van down by the river!', :age => '45', :gender => 'male', :city => 'Van down by the River', :state => 'NE', :ethnicity => 'pale as hell', :description => 'motivational speaker')
...
user4 = User.create(:name => 'WayneCampbell', :password_digest => '1', :tagline => 'excellent', :age => '38', :gender => 'male', :city => 'Aurora', :state => 'IL', :ethnicity => 'white', :description =>'Aurora public access TV talk show host')
...
user5 = User.create(:name => 'GarthAlgar', :password_digest => '1', :tagline => 'schwiiiiiiinnnng', :age => '37', :gender => 'male', :city => 'Aurora', :state => 'IL', :ethnicity => 'white', :description =>'Aurora public access TV talk show co-host')
